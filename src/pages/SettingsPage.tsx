...
import { buildBackupJsonFilename, buildSummaryTextFilename, downloadJsonFile, downloadTextFile, formatSummaryText } from '@/utils/export-utils';
...
export function SettingsPage() {
  ...
  const handleRetentionChange = (months: number) => {
    const newSettings: AppSettings = { ...state.settings, historyRetentionMonths: months };
    updateSettings(newSettings);
  };
  ...
  return (
    <motion.div variants={settingsVariants} initial="hidden" animate="visible">
      ...
      <motion.div layout className='flex flex-col gap-1'>
        ...
        <CurrencyCard value={state.settings.currency.code} options={currencyOptions} onChange={handleCurrencyChange} />
