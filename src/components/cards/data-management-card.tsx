    ...
    return (
        <motion.div className="card" variants={cardVariants}>
            ...
            <motion.div layout className='flex flex-col gap-1'>
                {/* Export */}
                <div className="">
                    <h3 className="font-bold" style={{ fontSize: '1rem' }}>Export Data</h3>
                    <p style={{ fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>
                        Download all your budget data as a JSON file for backup or transfer.
                    </p>
                    <div className='grid grid-cols-2'>
                        <motion.button
                            className="flex justify-center items-center gap-1 bg-white dark:bg-black border dark:border-white border-black rounded-l-lg h-10 text-black dark:text-white"
                            onClick={onExport}
                        ...
                        <motion.button
                            className="flex justify-center items-center gap-1 bg-black dark:bg-white px-2 border border-black rounded-r-lg h-10 text-white dark:text-black"
                ...
                <div className="flex flex-col gap-0.5">
                    <h3 className="font-bold" style={{ fontSize: '1rem' }}>Import Data</h3>
                    <p style={{ fontSize: '0.9rem', color: 'var(--color-text-secondary)'}}>
                ...
                {/* Clear Data */}
                <div className='flex flex-col gap-0.5'>
                    <h3 className="font-bold" style={{ fontSize: '1rem' }}>Reset All Data</h3>
                    <p style={{ fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>
